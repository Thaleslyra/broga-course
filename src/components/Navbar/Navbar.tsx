...
export default function Navbar() {
    return (
        <nav
            className=" flex flex-col ga-4 h-screen bg-slate-900 border-r border-indigo-400/40 hover:border-indigo-400/80 w-72">
            <div> logo<img src="" alt="" className="max-w-full p-2"/></div>
            {/*colocar a logo*/}
